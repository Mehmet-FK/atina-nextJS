...
const BookingsTableHeader = ({ column, tableRef }) => {
  ...
  return (
    <TableCell
      ...
      sx={{ ...tableStyles.th.cell, position: "absolute", width: "400px" }}
      align="left"
    >
      <Box
        sx={{
      ...
      >
        <Box sx={{ color: "#000" }}>{column.render("Header")} </Box>
    ...
    <>
      ...
      >
        ...
        >
          ...
          <Table
            {...getTableProps()}
            sx={{ minWidth: 650, border: "2px solid red" }}
          ...
          >
            <TableHead>
              {headerGroups.map((headerGroup) => (
                <TableRow
                  //   className={styles.tr}
                  sx={{ width: "100vw", border: "2px solid blue" }}
